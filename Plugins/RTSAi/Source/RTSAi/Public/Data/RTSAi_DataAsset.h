...
#include "RTSAi_DataAsset.generated.h"

class UEnvQuery;
class ARTSAi_ControllerBase;
class UBehaviorTree;
/**
 * 
 */
UCLASS()
class RTSAI_API URTSAi_DataAsset : public UPrimaryDataAsset
{
	GENERATED_BODY()
...
public:
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Configuration)
	TSoftClassPtr<ARTSAi_ControllerBase> AiControllerClass;
