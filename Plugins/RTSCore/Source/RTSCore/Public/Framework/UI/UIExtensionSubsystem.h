...
struct RTSCORE_API FUIExtensionPointHandle
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct RTSCORE_API FUIExtensionHandle
{
	GENERATED_BODY()
...
UCLASS()
class RTSCORE_API UUIExtensionSubsystem : public UWorldSubsystem
{
	GENERATED_BODY()
...
UCLASS()
class RTSCORE_API UUIExtensionHandleFunctions : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
...
UCLASS()
class RTSCORE_API UUIExtensionPointHandleFunctions : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
